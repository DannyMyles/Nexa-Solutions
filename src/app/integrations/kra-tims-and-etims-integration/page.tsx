...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nexagensolutions.com/integrations/kra-tims-and-etims-integration" },
};
...
const item = {
  ...
  bullets: [
    ...
    "KRA reporting and submission support",
    "Validation and retry mechanisms",
    "Operational reconciliation tools",
  ],
  pills: ["eTIMS Compliance", "Tax Invoice Automation", "KRA Reporting", "Retry & Validation"],
};

const howItWorks = [
  { title: "Configure", description: "We set up eTIMS credentials, tax codes, and invoice templates aligned to current KRA requirements." },
  { title: "Automate", description: "Every invoice generated in ERPNext is automatically submitted to eTIMS with the required QR code and fiscal data." },
  { title: "Report", description: "Compliance dashboards and reconciliation reports give your finance team full visibility into submission status." },
];

const impact = [
  { value: "100%", label: "eTIMS-compliant invoices, submitted automatically on generation" },
  { value: "Zero", label: "Manual KRA submissions — reporting flows directly from ERPNext" },
  { value: "Always ready", label: "Full submission history accessible for audits at any time" },
];

const audiences = ["VAT-Registered Businesses", "Retailers & Distributors", "Manufacturing Companies", "Finance & Tax Teams", "All KRA-registered Entities"];

const faqs = [
  { q: "Is this compatible with the current eTIMS API?", a: "Yes — we stay current with KRA API updates and handle version migrations proactively." },
  { q: "Do we need special hardware?", a: "No — the integration is entirely software-based within your ERPNext instance." },
  { q: "What if KRA's system is down?", a: "We queue submissions with retry logic so nothing is lost during KRA downtime windows." },
  { q: "Can historical invoices be submitted retroactively?", a: "We can assist with bulk historical submission workflows as part of onboarding." },
];
    ...
    <div className="flex flex-col">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Tax invoice compliance — built directly into your ERPNext workflow</h2>
              <p className="text-gray-600 mt-3 leading-relaxed">Every invoice submitted, validated, and QR-coded automatically — so your team processes sales normally while KRA compliance happens in the background.</p>
            ...
            <div className="rounded-2xl border border-gray-100 bg-gray-50 p-6">
              ...
              <div className="mt-4 space-y-3 text-sm text-gray-700">
                <div className="flex items-start gap-3">
                  ...
                  <span>We review your compliance obligations and current invoicing setup.</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="font-bold text-[#2F966E]">02</span>
                  <span>We design the TIMS/eTIMS integration and ERPNext tax configuration.</span>
                </div>
                <div className="flex items-start gap-3">
      ...
      <section className="py-14 bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-2">Solutions that benefit from eTIMS compliance</h2>
            <p className="text-gray-500 mt-2 text-sm">This integration is typically deployed alongside these ERPNext modules.</p>
          </div>
          <div className="flex flex-wrap justify-center gap-4">
            {[
              { label: "Accounting Software", href: "/solutions/accounting-software", desc: "Auto-submit every sales invoice to KRA" },
              { label: "POS System", href: "/solutions/pos-system", desc: "Issue compliant receipts at every till" },
              { label: "E-commerce Integration", href: "/solutions/e-commerce-integration", desc: "Tax-compliant invoices on every online order" },
            ].map((i) => (
              <Link
                key={i.label}
                href={i.href}
      ...
      <section className="py-20 bg-gradient-to-br from-[#2F966E] to-[#267A5A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">Ready to become KRA eTIMS compliant?</h2>
          <p className="text-white/90 text-lg mb-10 leading-relaxed">
            Start with a tailored audit or see the integration in action — we&apos;ll ensure every invoice meets KRA requirements.
          </p>

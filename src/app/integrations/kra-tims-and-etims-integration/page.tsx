      ...
      <section className="relative pt-28 pb-16 bg-gradient-to-br from-gray-50 via-white to-gray-100 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-sm font-semibold text-[#13ACB3] uppercase tracking-wider">Integrations</span>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-sm font-semibold text-[#13ACB3] uppercase tracking-wider">The Process</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {howItWorks.map((step, i) => (
              <div key={step.title} className="p-8 bg-white rounded-2xl border border-gray-100 shadow-sm text-center">
                <div className="w-12 h-12 bg-[#13ACB3] rounded-full flex items-center justify-center text-white font-bold text-lg mx-auto mb-4">{i + 1}</div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="text-sm font-semibold text-[#13ACB3] uppercase tracking-wider">Results</span>
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mt-2">Business impact</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {impact.map((stat) => (
              <div key={stat.label} className="p-8 bg-gradient-to-br from-[#13ACB3]/5 to-[#13ACB3]/10 rounded-2xl border border-[#13ACB3]/20 text-center">
                <div className="text-4xl font-bold text-[#13ACB3] mb-2">{stat.value}</div>

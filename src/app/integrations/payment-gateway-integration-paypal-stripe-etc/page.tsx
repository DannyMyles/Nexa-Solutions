...
export const metadata: Metadata = {
  ...
  description:
    "Connect external payment gateways so your sales and finance stay consistent end-to-end.",
};

const item: NavItem = {
  slug: "payment-gateway-integration-paypal-stripe-etc",
  label: "Payment Gateway Integration (PayPal, Stripe, etc.)",
  description:
    "Connect external payment gateways so your sales and finance stay consistent end-to-end.",
  bullets: [
    "Payment intent capture flows",

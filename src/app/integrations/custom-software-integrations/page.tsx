          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            <div>
              ...
              <p className="text-gray-600 mt-3 leading-relaxed">
                We map your data flows, design the API contracts, and build a production-ready integration — with error handling, retry logic, and monitoring configured from the start.
              </p>

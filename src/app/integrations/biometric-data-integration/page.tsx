...
export const metadata: Metadata = {
  title: "Biometric Data Integration | Nexa Solutions",
  description:
    "Sync biometric attendance data with HR/payroll workflows in a controlled and reliable manner.",
};

...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nexagensolutions.com/solutions/learning-management-system" },
};
...
const item = {
  ...
  pills: ["Student Enrollment", "Fee Collection", "Academic Scheduling", "Staff HR & Payroll"],
};
...
export default function LearningManagementSystemPage() {
  return (
    <div className="flex flex-col">
      <BreadcrumbJsonLd crumbs={[{ name: "Solutions", path: "/services" }, { name: "Learning Management System", path: "/solutions/learning-management-system" }]} />
      <FaqJsonLd faqs={faqs} />
      {/* Hero */}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Academic management — from enrollment through graduation</h2>
              <p className="text-gray-600 mt-3 leading-relaxed">One system covering students, fees, courses, timetables, and staff payroll — so your institution runs on data, not spreadsheets and paper.</p>

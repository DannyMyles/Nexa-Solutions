...
export const metadata: Metadata = {
  title: "HR and Payroll Software | Nexa Solutions",
  description:
...
export default function HrAndPayrollSoftwarePage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* Services cards (from /services) */}
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-sm font-semibold text-[#14B8A6] uppercase tracking-wider">ERPNext Services</span>
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mt-2">How we help you succeed</h2>
      ...
      <section className="py-20 bg-gradient-to-br from-[#14B8A6] to-[#0D9488]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">Ready to scope the right solution?</h2>

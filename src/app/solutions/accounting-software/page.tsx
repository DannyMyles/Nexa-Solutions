...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://nexagensolutions.com/solutions/accounting-software" },
};
...
const item = {
  ...
  pills: ["Chart of Accounts", "M-Pesa Reconciliation", "KRA Compliance", "Financial Reports"],
};
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Your complete accounting stack — configured for Kenya</h2>
              <p className="text-gray-600 mt-3 leading-relaxed">Every ledger, integration, and report built around your workflows — not a generic template. We handle setup, migration, training, and go-live.</p>
      ...
      <section className="py-14 bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-2">Recommended integrations for accounting</h2>
            <p className="text-gray-500 mt-2 text-sm">These integrations are commonly deployed alongside the accounting module.</p>
          </div>

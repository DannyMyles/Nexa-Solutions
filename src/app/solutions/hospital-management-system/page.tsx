...
export const metadata: Metadata = {
  title: "Hospital Management System | Nexa Solutions",
  description:
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            <div>
              ...
              <p className="text-gray-600 mt-3 leading-relaxed">
                An integrated HMS on ERPNext that connects clinical, billing, pharmacy, and management functions in one system.
              </p>

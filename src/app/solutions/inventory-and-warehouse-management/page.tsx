...
export const metadata: Metadata = {
  title: "Inventory & Warehouse Management Software Kenya",
  description:
    "Streamline stock control with ERPNext. Improve accuracy, automate movements, and keep your warehouse operations audit-ready.",
  alternates: { canonical: "https://nexagensolutions.com/solutions/inventory-and-warehouse-management" },
};
...
const item = {
  ...
  pills: ["Stock Control", "Barcode Support", "Warehouse Transfers", "Audit Trails"],
};
...
export default function InventoryAndWarehouseManagementPage() {
  return (
    <div className="flex flex-col">
      <BreadcrumbJsonLd crumbs={[{ name: "Solutions", path: "/services" }, { name: "Inventory and Warehouse Management", path: "/solutions/inventory-and-warehouse-management" }]} />
      <FaqJsonLd faqs={faqs} />
      {/* Hero */}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Complete stock visibility — from purchase order to delivery</h2>
              <p className="text-gray-600 mt-3 leading-relaxed">Every item movement recorded, every variance flagged, and every audit report ready when you need it. Built for warehouses that can't afford guesswork.</p>
      ...
      <section className="py-14 bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-2">Recommended integrations for inventory</h2>
            <p className="text-gray-500 mt-2 text-sm">Extend inventory with live storefront sync and automated payment reconciliation.</p>
          </div>
